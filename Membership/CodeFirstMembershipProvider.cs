    ...
    public class CodeFirstMembershipProvider : CodeFirstExtendedProvider
    {
        ...
        public override System.Web.Security.MembershipUser GetUser(string userName, bool userIsOnline)
        {
            ...
            using (WebApp4Context context = new WebApp4Context())
            {
                ...
                return new MembershipUser(System.Web.Security.Membership.Provider.Name, userName, user.Id, user.Email, null, null, true, false, user.CreateDate, DateTime.MinValue,
